...
void autonomous(void) {
  ...
  double distance =438;
double speed=200;
 MotorLF.spinToPosition(-distance,degrees,speed,rpm,false);
 MotorLB.spinToPosition(-distance,degrees,speed,rpm,false);
 MotorRF.spinToPosition(distance,degrees,speed,rpm,false);
 MotorRB.spinToPosition(distance,degrees,speed,rpm,false);
